...
const Technologies = () => {
  return (
    <div className="w-full h-auto flex flex-col text-center px-1  items-center mt-20 md:px-20">
      ...
      <div className='w-full flex flex-row flex-nowrap items-center gap-10 pt-20 overflow-scroll px-7 md:flex-wrap md:overflow-hidden md:px-0 md:justify-center'>
